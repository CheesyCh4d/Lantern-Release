...
Downloadable builds of **Lantern**, a tool for connecting to PowerSchool and running SQL based reports.

This repository hosts release binaries only. Each version is published under [**Releases**](../../releases) with installers for macOS, Windows, and Linux.
...
Lantern gives educators (Principals, Counselors, Teachers, etc) an easy to use interface for running SQL reports against PowerSchool.
